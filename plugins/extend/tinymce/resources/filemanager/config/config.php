...
/*
|--------------------------------------------------------------------------
| START - IMPLEMENT SUNLIGHT CMS FUNCTIONS !!!
| - Sunlight CMS the privilege of allowing the user to work only in the /upload/home/username/
|--------------------------------------------------------------------------
*/

$defdir = User::getHomeDir();
// create dir, if non exists
if (!(file_exists($defdir) && is_dir($defdir))) {
    $test = mkdir($defdir, 0777, true);
    if (!$test) {
        // creation failure
        echo _lang('admin.fman.msg.defdircreationfailure');
    } else {
        chmod($defdir, 0777);
    }
}
/*
|--------------------------------------------------------------------------
| END - IMPLEMENT SUNLIGHT CMS FUNCTIONS !!!
|--------------------------------------------------------------------------
*/
...
$config = array(
    ...
    */
    ...
    |
    */
    //'upload_dir' => '/upload/' . $user_home_path,
    'upload_dir' => '/' . ltrim(User::getHomeDir(),'/.'),
    /*
    |--------------------------------------------------------------------------
    ...
    |
    */
    //'current_path' => '../../../../../upload/' . $user_home_path,
    'current_path' => User::getHomeDir(),
    ...
    */
    ...
    |
    */
    'thumbs_upload_dir' => '/images/thumb/',
    ...
    */
    //'MaxSizeUpload' => 10,
    'MaxSizeUpload' => Environment::getUploadLimit(),
